...
Page({
    ...
    data: {
        ...
        tabData: [
            ...
            {index: 3,name:'代购', iconSrc:'/static/image/daigou.png',url:'../navpages/buy-agent/buy-agent'},
            {index: 4,name:'代送', iconSrc:'/static/image/daisong.png',url:'../navpages/designee/designee'},
            {index: 5,name:'其他服务', iconSrc:'/static/image/wanN.png',url:'../navpages/universal/universal'}
        ]
    },
    /**
     * 生命周期函数--监听页面加载
